import { CustomersListType, CustomerType, DebtsListType, DebtType, ModalCustomersType, ModalProductsType, PaymentType, ProductType, SalesListType, SaleType, ShopType } from "./types"
