...
export default function DebtsDetailPage({ id }: Props) {
  ...
  if (error || !data)
    return (
      <Typography color="error">دریافت اطلاعات با خطا مواجه شد.</Typography>
    );
      ...
      >
        <Stack direction="row" spacing={2} alignItems="center">
          <Link href={"/dashboard/debts"}>
            <Button startIcon={<ArrowForwardIosRounded />} variant="outlined">
              بازگشت
            </Button>
          </Link>
              ...
              <Stack direction="row" spacing={3} alignItems="center">
                ...
                <Box>
                  ...
                  <Stack direction="row" spacing={1} mt={1}>
                    ...
                    <Typography>{debt.customer_phone}</Typography>
                  </Stack>

                  <Chip
                    sx={{
                      mt: 2,
                      bgcolor: debt.is_paid ? "#22c55e" : "#f59e0b",
                      color: "#fff",
                      fontWeight: "bold",
                    }}
                    icon={<CheckCircleRounded />}
                    label={debt.is_paid ? "تسویه شده" : "دارای بدهی"}
                  />
                </Box>
              </Stack>
            </Grid>
          ...
          >
            ...
            >
              <CardContent>
                ...
                <Typography color="text.secondary">تومان</Typography>
              </CardContent>
            </MotionCard>
          </Grid>
        ))}
