  ...
  const faqData: FAQItem[] = [
    {
      ...
      answer:
        "بله، اطلاعات شما با پروتکل‌های پیشرفته AES-256 رمزنگاری شده و بر روی سرورهای ابری فوق‌امن نگهداری می‌شود. سیستم به طور خودکار هر ۶ ساعت یک بار بک‌آپ کامل تهیه می‌کند تا اطلاعات هرگز از دست نرود.",
    },
    {
      question: "اگر اینترنت فروشگاه موقتاً قطع شود چه اتفاقی می‌افتد؟",
      answer:
        "سامانه نسیه مجهز به سیستم آفلاین هوشمند (PWA) است. شما می‌توانید در زمان قطع اینترنت حساب‌ها را ثبت کنید و به محض اتصال مجدد، کل داده‌ها به طور خودکار همگام‌سازی خواهند شد.",
    },
    {
      question: "هزینه ارسال پیامک‌های یادآوری چگونه محاسبه می‌شود؟",
      answer:
        "در پلن حرفه‌ای، یک سهمیه پیامک ماهانه رایگان به شما اختصاص داده می‌شود. در صورت مصرف بیش از حد مجاز، می‌توانید بسته‌های پیامکی بسیار ارزان‌قیمت را بدون هیچ کارمزدی خریداری کنید.",
    },
  ];
    ...
    <div className="bg-white text-[#111827] antialiased font-vazir select-none">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-[#6B7280]">
            ...
            <a href="#faq" className="hover:text-[#1976D2] transition-colors">
              سوالات متداول
            </a>
          </nav>
            ...
            {user.isAuthenticated ? (
              <div className="">
                <Button
                  variant="contained"
                  color="primary"
                  href={user.is_shop ? "/dashboard" : "/account"}
                >
                  داشبورد من
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-6 space-y-8 text-center lg:text-right">
            ...
            <p className="text-base sm:text-lg text-[#6B7280] leading-relaxed max-w-xl mx-auto lg:mx-0">
              سامانه‌ای یکپارچه، امن و فوق‌سریع برای سوپرمارکت‌ها، داروخانه‌ها و
              کسب‌وکارهای کوچک. نسیه مشتریان را ثبت کنید، اقساط را پیگیری نمایید
              و هوشمندانه یادآور پیامکی بفرستید.
            </p>
          ...
          <div className="lg:col-span-6 relative mt-12 lg:mt-0 flex justify-center">
            ...
            <div className="absolute -top-6 right-4 sm:-right-6 bg-white/75 backdrop-blur-md border border-white/60 shadow-xl rounded-2xl p-4 flex items-center gap-4 z-20 animate-float-1 max-w-[220px]">
              ...
              <div>
                <div className="text-[11px] text-[#6B7280]">بدهی تسویه شد</div>
            ...
            <div className="absolute bottom-6 -left-4 sm:-left-8 bg-white/75 backdrop-blur-md border border-white/60 shadow-xl rounded-2xl p-4 flex items-center gap-4 z-20 animate-float-2 max-w-[230px]">
              ...
              <div>
                <div className="text-[11px] text-[#6B7280]">مشتری جدید</div>
                <div className="text-xs font-bold text-[#111827] mt-0.5">
                  داروخانه دکتر کریمی
                </div>
                <div className="text-[10px] text-[#6B7280]">
      ...
      <section className="py-12 border-y border-[#E5E7EB] overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-xs font-semibold text-[#6B7280] uppercase tracking-wider mb-8">
            بیش از ۱۰,۰۰۰ فروشگاه خرده‌فروشی و کسب‌وکار در سراسر ایران به نسیه
            اعتماد دارند
          </p>
          <div className="relative w-full flex items-center overflow-hidden">
            <div className="flex whitespace-nowrap gap-16 text-xl font-bold text-slate-300 animate-marquee">
              <span className="flex items-center gap-2 hover:text-slate-500 transition-colors cursor-pointer">
                <i className="fa-solid fa-shop"></i> فروشگاه‌های زنجیره‌ای افق
                کوروش
              </span>
              <span className="flex items-center gap-2 hover:text-slate-500 transition-colors cursor-pointer">
              ...
              <span className="flex items-center gap-2 hover:text-slate-500 transition-colors cursor-pointer">
                <i className="fa-solid fa-store"></i> هایپرمارکت‌های محلی تهران
              </span>
              <span className="flex items-center gap-2 hover:text-slate-500 transition-colors cursor-pointer">
                <i className="fa-solid fa-wheat-awn"></i> بنکداری و توزیع ارمغان
              </span>
              <span className="flex items-center gap-2 hover:text-slate-500 transition-colors cursor-pointer">
                <i className="fa-solid fa-bag-shopping"></i> زنجیره پوشاک سارک
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-[#6B7280] text-base">
              دیگر نیازی به کاغذ، ماشین‌حساب و دفاتر قدیمی ندارید. همه چیز
              اینجاست.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                تشکیل پرونده الکترونیک، ثبت مشخصات، تعیین سقف اعتبار خرید نسیه و
                مشاهده کل سابقه در یک صفحه واحد.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                بدون فوت وقت، مبلغ خرید، اقلام فاکتور و نام مشتری را وارد کرده و
                سند حسابداری را با دقت بالا ذخیره کنید.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                پشتیبانی از انواع روش‌های پرداخت اعم از نقدی، کارت به کارت، پوز
                بانکی و چک بانکی همراه با تاییدیه آنی تسویه.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                تقسیم فاکتور به اقساط ماهانه یا هفتگی، ردیابی وضعیت پرداخت هر
                قسط و مانیتورینگ دقیق سررسیدها.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                گزارش‌گیری از بدهی‌های معوقه، جریان نقدی، میزان وصولی روزانه و
                خروجی اکسل پیشرفته جهت ارائه به حسابدار.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                با موتور جستجوی آنی سیستم، در میان هزاران فاکتور و مشتری، هر
                داده‌ای را در کسری از ثانیه فورا پیدا کنید.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-[#6B7280] text-base">
              طراحی شده با الهام از مدرن‌ترین استانداردهای بین‌المللی برای آنکه
              در شلوغ‌ترین ساعات کار فروشگاه نیز خطا نکنید.
            </p>
          </div>
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-6 mb-6 flex-wrap gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="bg-slate-800 text-slate-300 px-4 py-2 rounded-xl text-xs flex items-center gap-2">
                  <CalendarMonthRounded /> خرداد ۱۴۰۵ - تیر ۱۴۰۵
                </div>
              ...
              <div className="lg:col-span-8 bg-slate-950/60 rounded-2xl border border-slate-800 p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-[#1976D2] font-medium cursor-pointer">
                    مشاهده جزئیات فاکتورها <TrendingUpRounded />
                  </span>
                </div>
                ...
                <div className="bg-slate-950/60 rounded-2xl border border-slate-800 p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-xs border-b border-slate-800/50 pb-2">
                      ...
                      <span className="text-emerald-500">موفق</span>
                    </div>
                    <div className="flex items-center justify-between text-xs border-b border-slate-800/50 pb-2">
                      <span className="text-slate-400">
                        تسویه اقساط داروخانه مرکزی
                      </span>
                      <span className="text-slate-500">۱۰ دقیقه پیش</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400">
                        پشتیبان‌گیری خودکار از سرور
                      </span>
                      <span className="text-[#42A5F5]">کامل شد</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <div className="flex justify-between text-xs">
                    <span className="text-[#6B7280]">کاهش خطای حسابداری</span>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-8">
            ...
            <p className="text-[#6B7280] text-base leading-relaxed">
              با نسیه، مدیریت مطالبات دیگر یک دغدغه کلافه‌کننده نیست. این سامانه
              با تمرکز بر نیاز دقیق بازارهای محلی ایران طراحی شده تا توازن مالی
              مغازه شما حفظ شود.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280] text-xs mt-1 leading-relaxed">
                    دسترسی و ثبت سریع اطلاعات بدون ورق زدن دفاتر سنگین فروشگاهی.
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280] text-xs mt-1 leading-relaxed">
                    محاسبات ریاضی دقیق و خودکار، بدون یک ریال مغایرت یا
                    جاافتادگی فاکتور.
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280] text-xs mt-1 leading-relaxed">
                    ذخیره‌سازی رمزنگاری‌شده ابری؛ دیگر نگران گم شدن، سوختن یا
                    خیس شدن دفتر نسیه نباشید.
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280] text-xs mt-1 leading-relaxed">
                    پیش از سررسید بدهی، سیستم به صورت محترمانه پیامک یادآوری
                    ارسال می‌کند.
                  </p>
                </div>
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-[#6B7280] text-base">
              رضایت کاربران، بزرگترین سرمایه و انگیزه ما در توسعه این محصول لوکس
              است.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-[#F8FAFC] p-8 rounded-2xl border border-[#E5E7EB] space-y-4">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                «از وقتی نسیه رو نصب کردیم، دیگه هیچ اختلافی سر حساب‌وکتاب با
                مشتری‌ها نداریم. سرعت اپلیکیشن فوق‌العادست و پیامک‌های اتوماتیک
                عالی عمل میکنن.»
              </p>
            ...
            <div className="bg-[#F8FAFC] p-8 rounded-2xl border border-[#E5E7EB] space-y-4">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                «رابط کاربری این نرم‌افزار به قدری ساده و قشنگه که شاگرد مغازه
                هم تو ۵ دقیقه کار باهاش رو یاد گرفت. گزارش‌های مالی اکسلش برای
                حسابدار ما عالیه.»
              </p>
              <div className="text-amber-500 text-xs">
                <StarRateRounded />
            ...
            <div className="bg-[#F8FAFC] p-8 rounded-2xl border border-[#E5E7EB] space-y-4">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">
                «بخش مدیریت اقساط نسیه واقعاً کار ما رو راحت کرده. قبلاً باید
                همش زنگ می‌زدیم ولی الان سیستم خودش سر زمان یادآوری می‌کنه و پول
                سر وقت نقد میشه.»
              </p>
              <div className="text-amber-500 text-xs">
                <StarRateRounded />
      ...
      <section id="pricing" className="py-24 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-[#6B7280] text-base">
              پلن خود را متناسب با حجم کسب‌وکارتان انتخاب کنید. بدون هزینه‌های
              پنهان.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[#6B7280] text-xs mt-1">
                    مناسب برای مینی‌مارکت‌ها و استارت کارهای نوپا
                  </p>
                </div>
                ...
                <ul className="space-y-3 text-sm text-[#6B7280] border-t border-slate-100 pt-6">
                  <li>
                    <DoneRounded /> مدیریت حداکثر تا ۵۰ مشتری
                  </li>
                  <li>
                  ...
                  <li className="line-through text-slate-300">
                    <CloseRounded /> ارسال پیامک یادآوری خودکار
                  </li>
                </ul>
              </div>
              <a
            ...
            <div className="bg-white p-8 rounded-3xl border-2 border-[#1976D2] shadow-xl flex flex-col justify-between relative transform lg:-translate-y-4">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[#6B7280] text-xs mt-1">
                    ویژه سوپرمارکت‌های شلوغ، داروخانه‌ها و مغازه‌های پرمشتری
                  </p>
                </div>
                ...
                <ul className="space-y-3 text-sm text-[#6B7280] border-t border-slate-100 pt-6">
                  <li>
                    ...
                    <span className="text-[#1976D2] font-bold">نامحدود</span>
                  </li>
                  <li>
                    <DoneRounded /> ارسال خودکار پیامک سررسید اقساط
                  </li>
                  <li>
                    <DoneRounded /> گزارش‌های مالی پیشرفته + خروجی Excel
                  </li>
                  <li>
                    <DoneRounded /> امکان اتصال به پوز بانکی مغازه
                  </li>
                  <li>
                    <DoneRounded /> پشتیبانی اولویت‌دار تلفنی
                  </li>
                </ul>
              </div>
              <a
            ...
            <div className="bg-white p-8 rounded-3xl border border-[#E5E7EB] shadow-sm flex flex-col justify-between">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[#6B7280] text-xs mt-1">
                    ویژه فروشگاه‌های زنجیره‌ای و بازرگانی‌های بزرگ
                  </p>
                </div>
                ...
                <ul className="space-y-3 text-sm text-[#6B7280] border-t border-slate-100 pt-6">
                  <li>
                    <DoneRounded /> اتصال به نرم‌افزارهای حسابداری داخلی شما
                  </li>
                  <li>
                    <DoneRounded /> استقرار بر روی سرورهای اختصاصی سازمان
                  </li>
                  <li>
                    <DoneRounded /> پنل پیامکی نامحدود اختصاصی
                  </li>
                  <li>
                    <DoneRounded /> پشتیبانی اختصاصی ۲۴ ساعته در ۷ روز هفته
                  </li>
                </ul>
              </div>
              <a
            ...
            {faqData.map((item, index) => (
              <div
                ...
                className={`border border-[#E5E7EB] rounded-2xl p-6 cursor-pointer transition-all ${
                  activeFaq === index ? "bg-white shadow-md" : "bg-slate-50"
                }`}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-gradient-to-br from-[#1565C0] to-[#1976D2] text-white rounded-3xl p-8 sm:p-12 text-center space-y-8 shadow-2xl relative overflow-hidden">
            ...
            <p className="text-blue-100 max-w-xl mx-auto text-sm sm:text-base leading-relaxed relative z-10">
              به جمع هزاران کاسب هوشمندی بپیوندید که با دفترهای قدیمی خداحافظی
              کرده‌اند. ثبت‌نام اولیه کمتر از ۱ دقیقه زمان می‌برد و نیازی به
              وارد کردن کارت بانکی نیست.
            </p>
      ...
      <footer className="bg-slate-900 text-slate-400 py-16 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-5 gap-8 border-b border-slate-800 pb-12 mb-12">
          <div className="col-span-2 space-y-4">
            ...
            <p className="text-xs text-slate-500 leading-relaxed max-w-sm">
              نسیه، پلتفرم برتر برای مدیریت نسیه، اقساط، طلب‌ها و جریان‌های مالی
              خرد ویژه اصناف و کسب‌وکار‌های کوچک ایرانی در سال ۲۰۲۶.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          <div>
            © ۲۰۲۶ سامانه مدیریت مالی نسیه. تمامی حقوق برای طراح محفوظ است.
          </div>
